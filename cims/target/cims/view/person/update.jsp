    ...
    <div class="ibox-content">
        <form action="${ctx}/person.do" class="form-horizontal m-t" id="personForm" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input class="form-control" name="name" placeholder="请输入人员名称" type="text" value="${entity.name}">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input class="form-control" name="code" placeholder="请输入身份证号" type="text" value="${entity.code}">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-credit-card"></i></span>
                        <input class="form-control" name="unit" placeholder="请输入人员单位" type="text" value="${entity.unit}">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <select class="form-control" name="grade">
                            ...
                            <option value="${map.key}" ${entity.grade==map.key?"selected":""}>${map.value}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input id="checkbox1" name="subsidy" value="1" type="checkbox" ${entity.heating==1?'checked':''}><label for="checkbox1">供暖</label>
                        <input id="checkbox2" name="subsidy" value="2" type="checkbox" ${entity.estate==1?'checked':''}><label for="checkbox2">物业</label>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="reason" placeholder="请输入更改原因">${entity.reason}</textarea>
                </div>
            </div>
            <div class="form-group">
