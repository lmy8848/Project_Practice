            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="" class="form-horizontal m-t" id="subsidyForm" method="post">
                        <input type="hidden" value="${requestScope.subsidy.type}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" name="" type="number" value="${requestScope.subsidy.money}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="">${requestScope.subsidy.reason}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
