...
<head>
    ...
    <title>人员管理</title>
    <link href="${ctx}
static/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
    <link href="${ctx}
static/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="${ctx}
static/css/animate.min.css" rel="stylesheet">
    <link href="${ctx}
static/css/style.min.css?v=4.0.0" rel="stylesheet">
</head>
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="btn-group">
                            ...
                            <button class="btn btn-danger" type="button" disabled>${requestScope.currentSize}/${requestScope.maxSize}/${requestScope.totalSize}</button>
                        </div>
...
<script src="${ctx}
static/js/jquery.min.js?v=2.1.4"></script>
<script src="${ctx}
static/js/bootstrap.min.js?v=3.3.5"></script>
<script src="${ctx}
static/js/content.min.js?v=1.0.0"></script>
<%--<script src="${ctx}--%>
<%--static/js/sweetalert212.js"></script>--%>
<script>
